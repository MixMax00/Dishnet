        ...
        getHTML: function (width, height) {
            ...
            if (navigator.userAgent.match(/MSIE/)) {
                ...
                html +=
                    ...
                    '" /><param name="loop" value="false" /><param name="menu" value="false" /><param name="quality" value="best" /><param name="bgcolor" value="#343a40" /><param name="flashvars" value="' +
                    flashvars +
                ...
                html +=
                    ...
                    '" src="' +
                    ZeroClipboard_TableTools.moviePath +
                    '" loop="false" menu="false" quality="best" bgcolor="#343a40" width="' +
                    width +
                    '" height="' +
                    height +
                    '" name="' +
