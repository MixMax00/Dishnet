                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($customers as $cus_list)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('admin.customer.status', ["id"=>$cus_list->id]) }}" class="btn btn-{{ $cus_list->status == 1 ? "warning" : "primary" }} btn-sm text-dark m-1">{{ $cus_list->status == 1 ? "Inactive" : "Active" }}</a>
