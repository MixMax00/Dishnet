...
<div class="row">
    ...
    <div class="card card-info">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="{{ route('admin.representative.store') }}" method="POST">
                @csrf
                <div class="card-body">
                  <div class="form-group row">
                    <label for="inputEmail3" class="col-sm-4 col-form-label">{{ __('messages.employee_name') }}</label>
                    <div class="col-sm-8">
                      <input type="text" name="employee_name" class="form-control" id="inputEmail3" placeholder="{{ __('messages.employee_name') }}">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputPassword3" class="col-sm-4 col-form-label">{{ __('messages.employee_designation') }}</label>
                    <div class="col-sm-8">
                      <input type="text" name="employee_designation" class="form-control" id="inputPassword3" placeholder="{{ __('messages.employee_designation') }}">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="cell_number" class="form-control" id="inputPassword3" placeholder="{{ __('messages.cell_number') }}">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <select name="responsible_area[]" class=" selectpicker form-control" data-dropup-auto="false"   data-live-search="true" multiple >
