...
@php($all_collections = \App\Models\AdminBillCollection::all())
            ...
            <div class="card">
                <div class="card-header">
                   <div class="d-flex align-items-center justify-content-between">
                       ...
                       <a href="{{ route('superadmin.collection.add')  }}" class="btn btn-info float-end"> Add Collection</a>
                   </div>
                </div>
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tr>
                            ...
                            <th>{{ __('messages.sp_id') }}</th>
                            <th>{{ __('messages.service_provider_name') }}</th>
