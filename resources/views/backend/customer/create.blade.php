              ...
              <form class="form-horizontal" action="{{ route('admin.customer.store') }}" method="POST">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="customer_name" class="form-control @error('customer_name') is-invalid @enderror" id="inputEmail3" placeholder="{{ __('messages.customer_name') }}">
                      @error('customer_name')
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-8">
                      <input type="text" name="customer_mobial_number"  class="form-control @error('customer_mobial_number') is-invalid @enderror" id="inputPassword3" placeholder="{{ __('messages.customer') }} {{ __('messages.cell_number') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea type="text" name="address" rows="4" class="form-control @error('address') is-invalid @enderror" id="inputPassword3" placeholder="Flat no, Floor no, Holding no etc"></textarea>
                            @error('address')
                          <p class="text-danger">{{ $message }}</p>
                      @enderror
                        </div>
                    ...
                    <div class="col-sm-8">
                      <select name="area" id="areaId" class="form-control @error('area') is-invalid @enderror">
